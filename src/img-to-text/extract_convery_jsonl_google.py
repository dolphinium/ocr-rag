...
input_folder = "../../data/raw/images/images_jpg_2"
output_file = "../../data/processed/book_text_2.jsonl"  # JSONL format for chunking in RAG

# Load Google Cloud service account credentials
creds = Credentials.from_service_account_file('../../../config/crucial-cabinet-448411-f0-0af14a4cf81e.json')
